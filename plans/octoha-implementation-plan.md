...
| ----- | --------------------------------------------------------- | -------------- | ---------- | ------------ | ----- |
| T-001 | Create `src/` directory structure for HA custom component | Sam Carrington | XS         | []           | true  |
| T-002 | Create `manifest.json` with integration metadata          | Sam Carrington | XS         | [T-001]      | true  |
| T-003 | Create `const.py` with constants and configuration keys   | Sam Carrington | XS         | [T-001]      | true  |
| T-004 | Set up pytest configuration and test directory structure  | Sam Carrington | S          | [T-001]      | true  |
| T-005 | Create GitHub Actions workflow for linting (ruff/pylint)  | Sam Carrington | S          | [T-001]      | true  |
| T-006 | Create GitHub Actions workflow for testing (pytest)       | Sam Carrington | S          | [T-004]      | true  |
| T-007 | Create `pyproject.toml` for development dependencies      | Sam Carrington | XS         | [T-001]      | true  |

### Phase 2: API Client Layer

| ID    | Title                                                              | Owner          | Complexity | Dependencies          | Done  |
| ----- | ------------------------------------------------------------------ | -------------- | ---------- | --------------------- | ----- |
| T-008 | Create `api/exceptions.py` with custom exception classes           | Sam Carrington | XS         | [T-001]               | true  |
| T-009 | Create `api/auth.py` with token management (GraphQL auth)          | Sam Carrington | M          | [T-008]               | true  |
| T-010 | Create `api/graphql.py` with query definitions                     | Sam Carrington | M          | [T-008]               | true  |
| T-011 | Create `api/rest.py` with consumption/tariff endpoint methods      | Sam Carrington | M          | [T-008]               | true  |
| T-012 | Create `api/client.py` main OctohaApiClient facade                 | Sam Carrington | L          | [T-009, T-010, T-011] | true  |
| T-013 | Create `models/account.py` with Account and MeterPoint dataclasses | Sam Carrington | S          | [T-001]               | true  |
| T-014 | Create `models/consumption.py` with Consumption dataclasses        | Sam Carrington | S          | [T-001]               | true  |
| T-015 | Create `models/tariff.py` with Tariff and Rate dataclasses         | Sam Carrington | S          | [T-001]               | true  |
| T-016 | Create `models/dispatch.py` with Dispatch dataclasses              | Sam Carrington | S          | [T-001]               | true  |
| T-017 | Write unit tests for API client authentication flow                | Sam Carrington | M          | [T-012]               | true  |
| T-018 | Write unit tests for consumption data retrieval                    | Sam Carrington | M          | [T-012, T-014]        | true  |
| T-019 | Write unit tests for tariff data retrieval                         | Sam Carrington | M          | [T-012, T-015]        | true  |
| T-020 | Add API response fixtures (JSON samples) for tests                 | Sam Carrington | S          | [T-004]               | true  |

### Phase 3: Config Flow & Integration Setup

| ID    | Title                                                              | Owner          | Complexity | Dependencies | Done  |
| ----- | ------------------------------------------------------------------ | -------------- | ---------- | ------------ | ----- |
| T-021 | Create `config_flow.py` with user step (API key input)             | Sam Carrington | M          | [T-012]      | true  |
| T-022 | Implement meter discovery step in config flow                      | Sam Carrington | M          | [T-021]      | true  |
| T-023 | Implement config flow validation and error handling                | Sam Carrington | S          | [T-022]      | true  |
| T-024 | Create `strings.json` and `translations/en.json` for UI strings    | Sam Carrington | S          | [T-021]      | true  |
| T-025 | Implement options flow for reconfiguration                         | Sam Carrington | M          | [T-023]      | true  |
| T-026 | Create `__init__.py` with async_setup_entry and async_unload_entry | Sam Carrington | M          | [T-023]      | true  |
| T-027 | Write integration tests for config flow                            | Sam Carrington | M          | [T-026]      | true  |

### Phase 4: Data Coordinators

| ID    | Title                                                          | Owner          | Complexity | Dependencies                 | Done  |
| ----- | -------------------------------------------------------------- | -------------- | ---------- | ---------------------------- | ----- |
| T-028 | Create `coordinator.py` with OctohaBaseCoordinator             | Sam Carrington | M          | [T-026]                      | true  |
| T-029 | Implement ElectricityCoordinator with 5-minute update interval | Sam Carrington | M          | [T-028]                      | true  |
| T-030 | Implement GasCoordinator with 5-minute update interval         | Sam Carrington | M          | [T-028]                      | true  |
| T-031 | Implement TariffCoordinator with 30-minute update interval     | Sam Carrington | M          | [T-028]                      | true  |
| T-032 | Implement DispatchCoordinator for Intelligent Go               | Sam Carrington | M          | [T-028]                      | true  |
| T-033 | Implement coordinator error handling and retry logic           | Sam Carrington | S          | [T-029, T-030, T-031, T-032] | true  |
| T-034 | Write unit tests for coordinator update logic                  | Sam Carrington | M          | [T-033]                      | true  |

### Phase 5: Entity Platforms

| ID    | Title                                                               | Owner          | Complexity | Dependencies                               | Done  |
| ----- | ------------------------------------------------------------------- | -------------- | ---------- | ------------------------------------------ | ----- |
| T-035 | Create `sensor.py` with base OctohaSensorEntity class               | Sam Carrington | S          | [T-029]                                    | true  |
| T-036 | Implement electricity consumption sensors (current, daily)          | Sam Carrington | M          | [T-035]                                    | true  |
| T-037 | Implement gas consumption sensors (current, daily)                  | Sam Carrington | M          | [T-035, T-030]                             | true  |
| T-038 | Implement electricity rate sensor with off-peak detection           | Sam Carrington | M          | [T-035, T-031]                             | true  |
| T-039 | Implement gas rate sensor                                           | Sam Carrington | S          | [T-035, T-031]                             | true  |
| T-040 | Implement dispatch sensors (next dispatch, active dispatch)         | Sam Carrington | M          | [T-035, T-032]                             | true  |
| T-041 | Create `binary_sensor.py` with off-peak and dispatch active sensors | Sam Carrington | M          | [T-031, T-032]                             | true  |
| T-042 | Implement entity attributes (metadata, timestamps, MPAN/MPRN)       | Sam Carrington | S          | [T-036, T-037, T-038, T-039, T-040, T-041] | true  |
| T-043 | Ensure Energy Dashboard compatibility (state_class, device_class)   | Sam Carrington | S          | [T-036, T-037]                             | true  |
| T-044 | Write unit tests for sensor state calculations                      | Sam Carrington | M          | [T-043]                                    | true  |

### Phase 6: Automation Support

| ID    | Title                                          | Owner          | Complexity | Dependencies   | Done  |
| ----- | ---------------------------------------------- | -------------- | ---------- | -------------- | ----- |
| T-045 | Implement octoha_off_peak_start/end events     | Sam Carrington | M          | [T-038]        | true  |
| T-046 | Implement octoha_dispatch_start/end events     | Sam Carrington | M          | [T-040]        | true  |
| T-047 | Document automation trigger examples in README | Sam Carrington | S          | [T-045, T-046] | true  |
| T-048 | Write integration tests for event firing       | Sam Carrington | S          | [T-046]        | true  |

### Phase 7: Diagnostics & Error Handling

| ID    | Title                                                         | Owner          | Complexity | Dependencies   | Done  |
| ----- | ------------------------------------------------------------- | -------------- | ---------- | -------------- | ----- |
| T-049 | Create `diagnostics.py` for debug data export (sanitized)     | Sam Carrington | S          | [T-026]        | true  |
| T-050 | Implement graceful degradation on API outages (cached values) | Sam Carrington | M          | [T-033]        | true  |
| T-051 | Implement stale data indication in entity states              | Sam Carrington | S          | [T-050]        | true  |
| T-052 | Add comprehensive DEBUG-level logging                         | Sam Carrington | S          | [T-012, T-028] | true  |

### Phase 8: Documentation

| ID    | Title                                                             | Owner          | Complexity | Dependencies | Done  |
| ----- | ----------------------------------------------------------------- | -------------- | ---------- | ------------ | ----- |
| T-053 | Write README.md with project overview and features                | Sam Carrington | M          | [T-043]      | true  |
| T-054 | Write installation guide (manual GitHub install)                  | Sam Carrington | S          | [T-053]      | true  |
| T-055 | Write configuration guide with screenshots                        | Sam Carrington | S          | [T-054]      | true  |
| T-056 | Write troubleshooting guide with common issues                    | Sam Carrington | M          | [T-055]      | true  |
| T-057 | Add inline code documentation (docstrings, type hints)            | Sam Carrington | M          | [T-044]      | true  |
| T-058 | Create CHANGELOG.md                                               | Sam Carrington | XS         | [T-053]      | true  |
| T-059 | Create LICENSE file with MIT license and open-octopus attribution | Sam Carrington | XS         | [T-001]      | true  |
